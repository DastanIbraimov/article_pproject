...
from webapp.views import article_list_view, article_create_view, article_detail_view, article_update_view, article_delete_view
...
urlpatterns = [
    ...
    path('article/<int:pk>/delete/', article_delete_view, name='delete_article'),
]
